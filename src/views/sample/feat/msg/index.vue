<template>
  <PageWrapper>
    <a-card title="Message" :bordered="false" class="!mb-4">
    ...
    <a-card title="Comfirm" :bordered="false" class="!mb-4">
    ...
    <a-card title="Modal" :bordered="false" class="!mb-4">
    ...
    <a-card title="Notification 用法与上面一致" :bordered="false" class="!mb-4">
