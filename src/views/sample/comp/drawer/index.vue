<template>
  <PageWrapper>
    <a-card title="抽屉组件使用示例" :bordered="false">
      <a-alert message="使用 useDrawer 进行抽屉操作" show-icon />
      <a-button type="primary" class="my-4" @click="openDrawerLoading"> 打开Drawer </a-button>

      <a-alert message="内外同时控制显示隐藏" show-icon />
      <a-button type="primary" class="my-4" @click="openDrawer2(true)"> 打开Drawer </a-button>
      <a-alert message="自适应高度/显示footer" show-icon />
      ...
      <a-alert message="详情页模式" show-icon />
